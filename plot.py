...
def main(csv, obj):
    ...
    prod_zi = griddata((producer_data['scale'], producer_data['blank ratio']), producer_data[obj], (xi, yi), method='cubic')
    reprod_zi = griddata((reproducer_data['scale'], reproducer_data['blank ratio']), reproducer_data[obj], (xi, yi), method='cubic')
    ...
    legend_elements = [Line2D([0], [0], color='r', lw=4, label='Producer '+ obj),
