...
def main():
    ...
    with PicoZKCompiler('irs/picozk_test', field=[p], options=['ram']):
        ...
        program = [
            ...
            ## Set j = 0
            Instr(1, 27, 27, 27, 27, 27, 0,  17, 27, 0),    ## Step0   #6: Set 0 idx17 (idx-j/reg2)
            ...
            Instr(2, 27, 27,  1, 27, 27, 27, 19, 27, 0),    ## Step10  #2: Add 1 to idx19 (temp-idx/reg3) = j+1
            ...
            Instr(2, 27, 27,  3, 27, 27, 27, 25, 27, 0),    ## Step13  #2: Add 3 to idx25 (temp-idx2/reg6) = j+3
            Instr(6, 25, 27, 27, 27, 27, 27, 21, 27, 0),    ## Step14  #6: Set mem[mem[25]] (mem[j+3]) to idx21
            Instr(7, 27, 27, 21, 27, 27, 27, 27, 19, 0),    ## Step15  #7: Set mem[idx21] (mem[j+3]) to mem[mem[idx19](=j+1)]
            
            ## Set mem[j+3] = temp2
            Instr(7, 27, 27, 23, 27, 27, 27, 27, 25, 0),    ## Step16  #7: Set mem[idx23/reg5] to mem[mem[idx25](=j+3)]

            ## Check if j < n-i-2 and determine to loop or end
            Instr(2, 27, 27,  2, 27, 27, 27, 17, 27, 0),    ## Step17  #2: Add 2 to idx 17 (idx-j/reg2)
            Instr(1, 27, 27, 27, 27, 27,  n, 21, 27, 0),    ## Step18  #1: Set 14 to idx 21 (reg4)
            Instr(2, 27, 27,  2, 27, 27, 27, 21, 27, 1),    ## Step19  #2: Subtract 2 from idx21 (reg4)
            Instr(2, 27, 27, 15, 27, 27, 27, 21, 27, 2),    ## Step20  #2: Subtract idx-i(idx15/reg1) from idx21 (reg4)
            Instr(3, 27, 26,  2, 27, 17, 27, 19, 27, 1),    ## Step21  #3: Compare idx17 (idx-j/reg2) < mem[p3] (n-i-2) and assign result to idx19 (reg3)
            Instr(4, 27, 19,  1, 23, 27, 27, 27, 27, 1),    ## Step22  #4: Cond jump to Step1/23 if true/false

            ## Check if i < n
            Instr(2, 27, 27, 2, 27, 27, 27, 15, 27, 0),     ## Step23  #2: Add 2 to idx 15 (idx-i/reg1)
            Instr(3, 27, 27, 2,  n, 15, 27, 19, 27, 0),     ## Step24  #3: Compare idx15 (idx-i/reg1) < n)(=14) and assign result to idx19 (reg3)
            Instr(4, 27, 19, 0, 26, 27, 27, 27, 27, 1),     ## Step25  #4: Cond jump to Step0/26 if true/false
        ...
        # Reproducer
        bg_list = [i for k, v in bg.items() for i in (k, v)] #0-9
